...
templates.push(
  ...
  tpl({
    ...
    description: "LinkedIn-inspired: blue banner header, section bars, clean sans layout.",
    layout: "single",
    theme: {
      ...baseTheme,
      primary: "#0a66c2",
      ...
      muted: "#666666",
      divider: "#e0e0e0",
      headingFont: '-apple-system, "Segoe UI", "Helvetica Neue", Arial, sans-serif',
      bodyFont: '-apple-system, "Segoe UI", "Helvetica Neue", Arial, sans-serif',
      sectionTitleStyle: "underline",
      sectionTitleTransform: "none",
      headerBg: "#0a66c2",
      headerText: "#ffffff",
    ...
    spacing: { ...baseSpacing, pageMarginTop: 0, headerPadding: 28 },
  }),
  tpl({
    id: "naukri",
    name: "Naukri Classic",
    description: "Naukri.com inspired: bold blue titles, tabular contact strip, ATS friendly.",
    layout: "single",
    theme: {
      ...baseTheme,
      primary: "#0a2540",
    ...
    spacing: { ...baseSpacing, sectionGap: 12, entryGap: 8 },
  }),
  tpl({
    id: "timesjobs",
    name: "TimesJobs Bold",
    description: "TimesJobs inspired: red accent header, serif titles, structured single column.",
    layout: "single",
    theme: {
      ...baseTheme,
      primary: "#b91c1c",
    ...
    spacing: { ...baseSpacing, pageMarginTop: 0 },
  }),
  tpl({
    id: "indeed",
    name: "Indeed Simple",
    description: "Indeed-style clean layout: dark blue header, ATS-first single column.",
    layout: "single",
    theme: {
      ...baseTheme,
      primary: "#2557a7",
  ...
  tpl({
    id: "monster",
    name: "Monster Purple",
    description: "Monster.com inspired: purple sidebar with contact & skills, main column for experience.",
    layout: "leftSidebar",
    theme: {
      ...baseTheme,
      primary: "#6e2c8f",
  ...
  tpl({
    id: "glassdoor",
    name: "Glassdoor Green",
    description: "Glassdoor inspired: green accents, modern two-column with clean bars.",
    layout: "twoCol",
    theme: {
      ...baseTheme,
      primary: "#0caa41",
    ...
    sidebarSections: ["skills", "languages", "certifications", "awards"],
    mainSections: ["summary", "experience", "projects", "education"],
  }),
);
